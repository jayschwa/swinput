 ...
 */
int
swkeybd_open (struct inode *inode, struct file *filp)
{
  return 0;			/* Ok */
}
 ...
 */
int
swkeybd_release (struct inode *inode, struct file *filp)
{
  return 0;
}
 ...
 */
int
fake_esc (char *str, int str_length)
{
 ...
 */
unsigned int
swkeybd_poll (struct file *filp, struct poll_table_struct *table)
{
